  ...
  render() {
    return (
      <div>
        ...
        <div className="about">
          <h1>About</h1>
          <p>This is a a writing app based on Krish Dholakiya's <a target="_blank" href="https://write.surge.sh/">Write</a> and inspired by <a target="_blank" href="http://www.hailoverman.com/flowstate">Flowstate</a>.</p>
          ...
          <a href="http://aunyks.com" className="extLink">/me</a> 
       </div>
      </div>
    );
  }
